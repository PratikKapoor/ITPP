...
extern "C"
{
	...
	int itpp_cross_deinterleaver(char *fname, unsigned long fname_len)
	{
		...
		sciErr = getVarAddressFromPosition(pvApiCtx, 3, &keepzeros);
		...
		/*=================================================================*/
	    	...
	    	sciErr = getMatrixOfDouble(pvApiCtx, keepzeros, &m2, &n2, &keepzerosMatrix);
